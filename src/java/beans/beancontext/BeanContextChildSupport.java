 ...
 * protocol  协议
 *
 * This class may either be directly（直接） subclassed(子类化), or encapsulated（封装的） and delegated（委派 ）
 * to in order to implement this interface for a given component（组件）.
 *
 * </p>
 *
